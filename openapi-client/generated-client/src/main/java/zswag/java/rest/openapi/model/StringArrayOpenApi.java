...
public class StringArrayOpenApi   {
  @JsonProperty("fromList")
  @Valid
  private List<String> fromList = null;

  public StringArrayOpenApi fromList(List<String> fromList) {
    this.fromList = fromList;
    return this;
  }

  public StringArrayOpenApi addFromListItem(String fromListItem) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    StringArrayOpenApi stringArray = (StringArrayOpenApi) o;
    return Objects.equals(this.fromList, stringArray.fromList);
  }
  ...
  public String toString() {
    ...
    sb.append("class StringArrayOpenApi {\n");
