...
public class Integers implements zserio.runtime.io.InitializeOffsetsWriter, zserio.runtime.SizeOf
{
    public Integers()
    {
    }

    public Integers(java.io.File file)
    ...
    public Integers(zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException, zserio.runtime.ZserioError
    {
        read(in);
    }
    ...
    public Integers(
        zserio.runtime.array.IntArray values_)
    {
        setValues(values_);
    }
    ...
    public int bitSizeOf(long bitPosition)
    {
        ...
        endBitPosition += getValues().bitSizeOfAuto(endBitPosition, 32);

        return (int)(endBitPosition - bitPosition);
    }

    public zserio.runtime.array.IntArray getValues()
    {
        return this.values_;
    }

    public void setValues(zserio.runtime.array.IntArray values_)
    {
    ...
    public boolean equals(java.lang.Object obj)
    {
        ...
        {
            final Integers that = (Integers)obj;
    ...
    public void read(final zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException, zserio.runtime.ZserioError
    {
        this.values_ = new zserio.runtime.array.IntArray(in,
                zserio.runtime.array.Array.AUTO_LENGTH, 32);
    }
    ...
    public long initializeOffsets(long bitPosition)
    {
        ...
        endBitPosition = getValues().initializeOffsetsAuto(endBitPosition, 32);
    ...
    public void write(zserio.runtime.io.BitStreamWriter out, boolean callInitializeOffsets)
            throws java.io.IOException, zserio.runtime.ZserioError
    {
        getValues().writeAuto(out, 32);
    }

    private zserio.runtime.array.IntArray values_;
}
