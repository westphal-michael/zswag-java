...
public class Integers implements zserio.runtime.io.InitializeOffsetsWriter, zserio.runtime.SizeOf
{
    ...
    public Integers(zserio.runtime.array.PackingContextNode contextNode, zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(contextNode, in);
    }
    ...
    public void setValues(int[] values_)
    {
        this.values_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.IntRawArray(values_),
