...
public class Doubles implements zserio.runtime.io.InitializeOffsetsWriter, zserio.runtime.SizeOf
{
    ...
    public Doubles(
        zserio.runtime.array.Float64Array values_)
    {
        setValues(values_);
    }
    ...
    public zserio.runtime.array.Float64Array getValues()
    {
        return this.values_;
    }

    public void setValues(zserio.runtime.array.Float64Array values_)
    {
    ...
    public void read(final zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException, zserio.runtime.ZserioError
    {
        this.values_ = new zserio.runtime.array.Float64Array(in,
    ...
    private zserio.runtime.array.Float64Array values_;
}
